    ...
    <section>
        <div className='row bg-gradient-to-b from-[#5858ec]/10 to-transparent'>
            ...
            <div className='w-full md:w-8/12 lg:w-9/12 bg-gray-300 p-2 md:bg-transparent'>
               <div>
                  <div className='bg-white w-full mx-auto h-[300px] md:w-11/12 lg:w-8/12 xl:w-7/12 shadow-md shadow-black/80 rounded-xl'>
                      <img src={camera} className="cover-image" alt="" />
                  </div>
               </div>
            </div>
        </div>
