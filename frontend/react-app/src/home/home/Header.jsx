...
import { Cart,Slider,MinHeader } from '../components.jsx'
...
export default function Header(){
  ...
  return(
    <section className='container'>
      ...
      {/* NAVBARR */}
      {!scrolling && 
        <motion.div className='flex md:hidden fixed items-center bg-slate-100 top-0 h-[61px] z-50 w-full left-0' variants={Scrolling} initial="initial" animate="animate">
